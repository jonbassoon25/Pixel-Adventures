...
export class Dialogue {
	static dialogue = {
		"level1": [
			"Greetings fellow explorers! \nI am Flame, the archaeologist.\nI am here to investigate the castle ruins and claim the treasure\nI will find along the way.", //Flame
		...
		"level3": [
			...
			"And we\'re so close to winning!", //Flame
	...
	static loadDialogue(level) {
		switch (level) {
			case 1:
				this.messageQueue = this.dialogue["level1"];
				break;
			case 2:
				this.messageQueue = this.dialogue["level2"];
				break;
			case 3:
				this.messageQueue = this.dialogue["level3"];
				break;
			case 4:
				this.messageQueue = this.dialogue["level4"];
				break;
		}
